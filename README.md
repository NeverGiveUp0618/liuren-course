...
2026-08-23 起写，当前 **25 课已成 13 课**——第一部分「把盘立起来」（1-7）与第二部分「读懂盘上的字」（8-12）已全，第三部分从第 13 课起。
...
| 脚本 | 查什么 | 抓到过什么 |
|---|---|---|
| `_tools/_verify_cite.py` | 每条「」引文回原书 OCR 按页核对（引文跨页也认） | 累计抓到 **9 处页码错标**、**一处给引文私加了"地盘"二字**、**一处引了 OCR 讹字** |
| `_tools/_audit_pan.py` | 两层：内置 case 复算比对 ＋ **扫描课文里每一张盘**验证自洽（天盘必须是整体平移、天将必须自贵人起连续顺/逆） | 当前 8 张盘 0 处不符 |
...
- 12 课未写（第 14 课起）。写法与自检标准见 `content/00-总目录与学习路线.md` 和上面两个脚本。
- 五术堂导航入口未接。
